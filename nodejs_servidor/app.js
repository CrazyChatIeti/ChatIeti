...
app.post('/data', upload.single('file'), async (req, res) => {
  ...
  if (objPost.type === 'test') {
    ...
    let prompt = objPost.prompt == "" ? "explain that image" : objPost.prompt
